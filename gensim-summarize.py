...
# We create extractive summaries using gensim.
...
# Path for the gensim summaries
gensim_summary_with_removal_path = '../../data/summary/gensim-summary-with-removal-tst.txt'
gensim_summary_without_removal_path = '../../data/summary/gensim-summary-without-removal-tst.txt'

# Read the data
gensim_summary_with_removal = open(gensim_summary_with_removal_path, 'w')
gensim_summary_without_removal = open(gensim_summary_without_removal_path, 'w')
